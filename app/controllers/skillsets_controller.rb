class SkillsetsController < ApplicationController
  ...
  # GET /skillsets/new
  def new
    @skillset = current_staff.skillsets.build
    @tools = Tool.all
  end
  ...
  # POST /skillsets.json
  def create
    @skillset = current_staff.skillsets.build(skillset_params)
  ...
  private
    ...
    def skillset_params
      params.require(:skillset).permit(:staff_id, :tool_id, :proficiency)
    end
end
